...
using SisGesVentas.Client;
using SisGesVentas.Data;
using System.Diagnostics;
using System.Security.Claims;

namespace SisGesVentas.Components.Account
{
    ...
    internal sealed class PersistingRevalidatingAuthenticationStateProvider : RevalidatingServerAuthenticationStateProvider
    {
        ...
        public readonly PersistentComponentState state;
        public readonly IdentityOptions options;

        public readonly PersistingComponentStateSubscription subscription;
